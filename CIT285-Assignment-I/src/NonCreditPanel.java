...
public class NonCreditPanel extends PartTimePanel{
    public NonCreditPanel() throws ParseException{
       ...
       public void actionPerformed(ActionEvent e){
           if(e.getSource()==submitButton){
            ...
            for(int i = 0; i < values.length; i++){
                 ...
                 insertCourses.setString(2, ncCourses[i].getNumber());
                 insertCourses.setString(3, ncCourses[i].getName());
                 insertCourses.setString(4, ncCourses[i].getInfo());
                 
                 insertCourses.executeUpdate();
                                  
                 insertFinancial.setString(1, ssN.getText());                 
                 insertFinancial.setString(2, ncCourses[i].getNumber());
